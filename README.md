...
- the tool surface is 9 tools and 64 operations, identical through the MCP server and the CLI
...
- the semantic surface is Outlook-only: 9 tools, 64 operations, identical through the MCP server and the CLI (see [FEATURES.md](FEATURES.md))
...
The repository exposes **9 tools with 64 operations**, generated into both the MCP server and the

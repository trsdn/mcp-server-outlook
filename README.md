...
- the tool surface is 8 tools and 66 operations, identical through the MCP server and the CLI
...
- the semantic surface is Outlook-only: 8 tools, 66 operations, identical through the MCP server and the CLI (see [FEATURES.md](FEATURES.md))
...
The repository exposes **8 tools with 66 operations**, generated into both the MCP server and the

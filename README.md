...
- the tool surface is 11 tools and 67 operations, identical through the MCP server and the CLI
...
- the semantic surface is Outlook-only: 11 tools, 67 operations, identical through the MCP server and the CLI (see [FEATURES.md](FEATURES.md))
...
The repository exposes **11 tools with 67 operations**, generated into both the MCP server and the

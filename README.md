...
- the tool surface is 7 tools and 57 operations, identical through the MCP server and the CLI
...
- the semantic surface is Outlook-only: 7 tools, 57 operations, identical through the MCP server and the CLI (see [FEATURES.md](FEATURES.md))
...
The repository exposes **7 tools with 57 operations**, generated into both the MCP server and the

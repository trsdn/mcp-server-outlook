...
async function main() {
  ...
  const prompt = `Read the file C:\\Users\\torstenmahr\\github\\mcp-server-outlook\\skills\\shared\\slide-design-principles.md and tell me how many sections (## headings) are defined in it. Just the count.`;

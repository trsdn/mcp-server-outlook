...
@pytest.mark.asyncio
async def test_cli_range_set_get(aitest_run, outlook_cli_server, outlook_cli_skill, fixtures_dir):
    agent = Agent(
        name="cli-range",
...
@pytest.mark.asyncio
async def test_cli_range_error_handling(aitest_run, outlook_cli_server, outlook_cli_skill):
    agent = Agent(

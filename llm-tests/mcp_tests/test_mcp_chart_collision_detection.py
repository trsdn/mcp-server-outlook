...
@pytest.mark.asyncio
async def test_mcp_auto_position_no_skill(aitest_run, outlook_mcp_server):
...
@pytest.mark.asyncio
async def test_mcp_targetrange_no_skill(aitest_run, outlook_mcp_server):
...
@pytest.mark.asyncio
async def test_mcp_collision_warning_reaction_no_skill(aitest_run, outlook_mcp_server):

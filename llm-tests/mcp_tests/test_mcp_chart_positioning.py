...
async def test_mcp_chart_position_below_data(aitest_run, outlook_mcp_server, outlook_mcp_skill):
    agent = Agent(
...
@pytest.mark.asyncio
async def test_mcp_chart_position_right_of_table(aitest_run, outlook_mcp_server, outlook_mcp_skill):
    agent = Agent(

...
@pytest.mark.asyncio
async def test_mcp_table_create_query(aitest_run, outlook_mcp_server, outlook_mcp_skill):
    agent = Agent(
...
@pytest.mark.asyncio
async def test_mcp_table_lifecycle(aitest_run, outlook_mcp_server, outlook_mcp_skill):
    agent = Agent(

...
$toolActionsPath = Join-Path $rootDir "src\OutlookMcp.Core\Models\Actions\ToolActions.cs"
$programPath = Join-Path $rootDir "src\OutlookMcp.CLI\Program.cs"
...
if ($missingCommands.Count -gt 0) {
    ...
    Write-Host "  1. Create Command class: src/OutlookMcp.CLI/Commands/<Name>Command.cs" -ForegroundColor Yellow

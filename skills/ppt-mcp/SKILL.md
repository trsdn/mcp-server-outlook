...
Provides 243 Outlook operations via Model Context Protocol. The MCP server forwards
...
may still contain `PptMcp`. Public guidance should nevertheless stay Outlook-first.

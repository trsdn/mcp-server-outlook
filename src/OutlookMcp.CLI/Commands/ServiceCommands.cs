...
namespace OutlookMcp.CLI.Commands;
...
/// <summary>
/// Starts the migration CLI service daemon if not already running.
/// Launches a background process running "outlookcli service run".
/// </summary>
...
/// <summary>
/// Gracefully stops the migration CLI service daemon.
/// </summary>
...
/// <summary>
/// Shows migration CLI service status including PID, legacy session count, and uptime.

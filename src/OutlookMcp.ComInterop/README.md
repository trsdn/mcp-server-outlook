...
This library provides PowerPoint-specific COM object lifecycle management and OLE message filtering. It's the foundation layer for OutlookMcp projects, handling STA threading, session management, and batch operations specifically for PowerPoint COM automation.

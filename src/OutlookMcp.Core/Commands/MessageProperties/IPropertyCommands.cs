...
[McpTool("property", Title = "Outlook Message Property Operations", Destructive = false, Category = "property",
    ...
    + "inside one organisation. headersPresent is also false when Outlook refused the read, so check "
    + "status before concluding a message has none: blocked means the headers exist and were "
    + "withheld. "

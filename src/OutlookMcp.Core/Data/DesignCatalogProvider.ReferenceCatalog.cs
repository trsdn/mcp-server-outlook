...
namespace OutlookMcp.Core.Data;

internal static partial class DesignCatalogProvider
{
    private const string ReferenceCatalogRootEnvironmentVariable = "OUTLOOKMCP_REFERENCE_DATA_ROOT";
    private const string EvalAssetRepoRootEnvironmentVariable = "OUTLOOKMCP_EVAL_ASSET_REPO_ROOT";

...
namespace OutlookMcp.Generators.Mcp;
...
public class McpToolGenerator : IIncrementalGenerator
{
    ...
    private static string GenerateToolClass(ServiceInfo info)
    {
        ...
        if (hasProgress)
        {
            ...
            sb.AppendLine("using OutlookMcp.ComInterop;");
            sb.AppendLine("using OutlookMcp.McpServer.Progress;");
        }
        sb.AppendLine();
        sb.AppendLine("namespace OutlookMcp.McpServer.Tools;");
        sb.AppendLine();
        ...
        foreach (var ep in exposedParams)
        {
                     ...
                     ep.TypeName.StartsWith("List<string>"))
            {
                ...
                result.Add(new McpParameter(
                    ...
                    defaultExpression: "null",
                    preProcessingCode: $"var {localVarName} = OutlookMcp.Core.Utilities.ParameterTransforms.ParseJsonList({snakeName}, nameof({snakeName}));"));
            }
            else
            {

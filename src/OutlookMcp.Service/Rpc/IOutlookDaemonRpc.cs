...
///
/// The interface has a single method that delegates to <see cref="OutlookMcpService.ProcessAsync"/>,
...
public partial interface IOutlookDaemonRpc
{
    ...
    /// Wraps <see cref="OutlookMcpService.ProcessAsync"/> over the pipe transport.
    /// </summary>

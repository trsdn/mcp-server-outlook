...
using SharedProtocol = OutlookMcp.ComInterop.ServiceClient.ServiceProtocol;
using SharedRequest = OutlookMcp.ComInterop.ServiceClient.ServiceRequest;
using SharedResponse = OutlookMcp.ComInterop.ServiceClient.ServiceResponse;

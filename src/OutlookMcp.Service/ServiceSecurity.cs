...
/// <summary>
/// Security utilities for OutlookMcp Service named pipe communication.
/// Ensures per-user isolation via SID-based pipe names and ACLs.
/// </summary>
/// <remarks>
/// <para><b>Pipe Name Strategy:</b></para>
/// <list type="bullet">
///   <item>MCP Server: OutlookMcp-mcp-{SID}-{PID} (per-process isolation, each instance independent)</item>
///   <item>CLI daemon: OutlookMcp-cli-{SID} (per-user, shared across CLI invocations)</item>
/// </list>

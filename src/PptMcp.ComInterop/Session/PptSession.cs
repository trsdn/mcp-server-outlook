...
/// <summary>
/// Legacy entry point for inherited PowerPoint COM interop operations using the batch pattern.
/// This remains in the tree during migration while Outlook-first automation is rebuilt elsewhere.
/// </summary>

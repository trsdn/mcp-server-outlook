...
Until the cleanup pass lands, expect inherited names nearby such as `PptMcp.*`, `mcp-ppt`, and `ppt-mcp`. Those are transitional and not the intended long-term Outlook branding.

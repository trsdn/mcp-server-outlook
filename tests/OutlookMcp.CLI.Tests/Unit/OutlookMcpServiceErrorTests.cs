...
/// <summary>
/// Unit tests for OutlookMcpService error handling.
///
...
[Trait("Layer", "Service")]
[Trait("Category", "Unit")]
[Trait("Feature", "OutlookMcpService")]
[Trait("Speed", "Fast")]
public sealed class OutlookMcpServiceErrorTests
{
    /// <summary>
    ...
    {
        // Arrange
        using var service = new OutlookMcpService();

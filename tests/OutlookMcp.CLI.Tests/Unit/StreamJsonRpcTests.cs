...
{
    private readonly OutlookMcpService _service = new();

    /// <summary>
    /// Validates end-to-end RPC round-trip: client sends ServiceRequest through StreamJsonRpc,
    /// DaemonRpcTarget delegates to OutlookMcpService.ProcessAsync, response returns correctly.
    /// </summary>
    [Fact]
...
#pragma warning restore CS8714
            ...
            // Act — OutlookMcpService.ProcessAsync catches NullReferenceException internally

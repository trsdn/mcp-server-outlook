...
namespace OutlookMcp.Core.Tests.Helpers;
...
internal static class ReferenceCatalogFixture
{
    ...
    public static string GetCatalogRoot()
    {
        ...
        {
            var repoPath = Path.Combine(current.FullName, "tests", "OutlookMcp.Core.Tests", "TestAssets", "ReferenceCatalog");
    ...
    public static Dictionary<string, string> GetEnvironmentVariables()
    {
        ...
        {
            ["OUTLOOKMCP_REFERENCE_DATA_ROOT"] = GetCatalogRoot()
        };
    }

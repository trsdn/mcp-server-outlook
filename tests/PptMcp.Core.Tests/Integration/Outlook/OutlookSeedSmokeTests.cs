...
using PptMcp.Core.Commands.Attachment;
using PptMcp.Core.Commands.Application;
using PptMcp.Core.Commands.Calendar;
using PptMcp.Core.Commands.Folder;
using PptMcp.Core.Commands.Mail;
...
namespace PptMcp.Core.Tests.Integration.Outlook;

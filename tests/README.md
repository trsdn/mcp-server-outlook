...
OutlookMcp is now an Outlook COM automation server. The current product surface is 8 Outlook tools with 62 operations: mail, calendar, contact, task, rule, folder, attachment, and application.

...
OutlookMcp is now an Outlook COM automation server. The current product surface is 11 Outlook tools with 67 operations: mail, calendar, contact, task, rule, folder, attachment, application, sync, signature, and oof.

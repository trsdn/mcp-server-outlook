...
OutlookMcp is now an Outlook COM automation server. The current product surface is 10 Outlook tools with 69 operations: mail, folder, calendar, contact, task, attachment, application, addressbook, and property.

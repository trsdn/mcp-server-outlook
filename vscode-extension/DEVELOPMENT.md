...
│   ├── outlook-mcp/        # MCP server skill
│   │   └── SKILL.md
│   ├── outlook-cli/        # CLI skill
│   │   └── SKILL.md
...
```json
"chatSkills": [
  { "path": "./skills/outlook-mcp/SKILL.md" },
  { "path": "./skills/outlook-cli/SKILL.md" }
]
```
...
- Agent Skills (~130 KB for both outlook-mcp and outlook-cli)

...
The server exposes **10 tools with 69 operations**:
...
| `addressbook` | `resolve`, `list-address-lists`, `list-entries` |
| `property` | `get-headers`, `get-known`, `get-property`, `list-user-properties` |
